...
<p><h1>Add Gym</h1></p>
    ...
    <form action="" method="post">
        ...
        <input style="border-radius: 10px;" id='name'  class="form-control" name="name" placeholder="Gym Name" required></input>
    </div>
        <div class="form-group">
        <input style="border-radius: 10px;" id='address' class='form-control' name='address' placeholder="Gym Address"  required></input>
    </div>
        <div class="form-group">

        <input style="border-radius: 10px;" id='mobile' class='form-control' name='mobile' placeholder="Contact" required></input>
    </div>
        
        <button style="border-radius: 10px;" class="btn btn-success mt-3" name="submit"  class="bmbtn" value="submit">Add gym</button>
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql = "INSERT INTO gym (gym_name,gym_address,gym_contact)
VALUES ('$name','$address','$mobile') ";

if ($con->query($sql) === TRUE) {

    echo "<p><h1>GYM Added  " .$name."</h1></p>";
